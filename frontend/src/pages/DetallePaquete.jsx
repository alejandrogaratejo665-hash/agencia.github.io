...
import { FaMapMarkerAlt, FaStar, FaCheckCircle, FaCalendar, FaUsers, FaCamera, FaHeart, FaShareAlt } from 'react-icons/fa';
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <button className="w-full text-center bg-gold text-black py-4 px-6 rounded-xl font-black hover:bg-gold/90 transition-all duration-300 shadow-lg hover:shadow-xl text-lg">
                    Reservar Ahora
                  </button>
